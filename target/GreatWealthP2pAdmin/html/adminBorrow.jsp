...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'borrowtime', width:130, title: '借款时间', sort: true ,templet:'<div>{{ layui.util.toDateString(d.registertime, "yyyy-MM-dd") }}</div>',align:'center'}
      ,{field:'borrowproject', width:130, title: '借款项目',align:'center'}
      ,{field:'borrowtype', width:130, title: '借款类型',align:'center'}
      ,{field:'borrowmoney', width:135, title: '借款金额', sort: true,align:'center'}
    ]]
    ,page: true
  });
});
